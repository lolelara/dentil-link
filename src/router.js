...
export const initRouter = () => {
    ...
    router
        .on({
            ...
            '/patient/suggestions': () => render('/views/patient/suggestions.html'),
            '/patient/dashboard': () => render('/views/patient/dashboard-complete.html'),
            '/patient/history': () => render('/views/patient/history.html'),
            '/patient/notifications': () => render('/views/patient/notifications.html'),
            '/patient/insurance': () => render('/views/patient/insurance.html'),
            '/patient/follow-up': () => render('/views/patient/follow-up.html'),
            '/patient/progress': () => render('/views/patient/progress-tracker.html'),
            '/patient/check-account': () => render('/views/patient/check-account.html'),
